...
<div class="w-3/4 flex justify-end">
  <a href="create_pemilik.php" class="bg-teal-500 hover:bg-teal-400 text-white font-bold py-2 px-4 border-b-4 border-teal-700 hover:border-teal-500 rounded">
    Tambah pemilik
  </a>
</div>
          ...
          <tbody>
            ...
            <tr class="bg-gray-100 border-b">
              ...
              <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap flex gap-4">
                <a href="update_pemilik.php?id=<?= $item["id_pemilik"] ?>" class="bg-sky-500 hover:bg-sky-400 text-white font-bold py-2 px-4 border-b-4 border-sky-700 hover:border-sky-500 rounded">
                  update
                </a>
                <a href="../function/pemilik/delete_pemilik.php?id=<?= $item["id_pemilik"] ?>" class="bg-red-500 hover:bg-red-400 text-white font-bold py-2 px-4 border-b-4 border-red-700 hover:border-red-500 rounded">
                  delete
                </a>
              </td>
            </tr>
