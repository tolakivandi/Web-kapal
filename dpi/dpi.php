...
$query = "SELECT * FROM dpi order by id_dpi desc";
$result = mysqli_query($connection,$query);
$data = [];
while($dpi = mysqli_fetch_assoc($result)) {
  $data[] = $dpi;
}
?>
<!doctype html>
    ...
    <div class="container mx-auto flex flex-wrap items-center justify-between">
      <a href="" class="flex h-max items-center gap-3 font-semibold">
        ...
        <ul class="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
            ...
            <li>
            <a href="dpi.php" class="text-white hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">DPI</a>
            </li>
            <li>
...
<div class="w-3/4 flex justify-end">
  <a href="createdpi.php" class="bg-teal-500 hover:bg-teal-400 text-white font-bold py-2 px-4 border-b-4 border-teal-700 hover:border-teal-500 rounded">
    Tambah Dpi
  </a>
</div>
          ...
          <tbody>
            ...
            <tr class="bg-gray-100 border-b">
              ...
              <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap flex gap-4">
                <a href="updatedpi.php?id=<?= $item["id_dpi"] ?>" class="bg-sky-500 hover:bg-sky-400 text-white font-bold py-2 px-4 border-b-4 border-sky-700 hover:border-sky-500 rounded">
                  update
                </a>
                <a href="../function/dpi/deletedpi.php?id=<?= $item["id_dpi"] ?>" class="bg-red-500 hover:bg-red-400 text-white font-bold py-2 px-4 border-b-4 border-red-700 hover:border-red-500 rounded">
                  delete
                </a>
              </td>
            </tr>
