...
<body>
  ...
  <!-- component -->
<form method="post" action="../function/dpi/createdpi.php" class="w-full overflow-scroll h-screen bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 p-4 flex items-center justify-center" >
    <div class="bg-white py-6 px-10 sm:max-w-md w-full rounded">
        ...
        <div class="flex flex-col gap-7">
            <div>
                 <input type="text" class="focus:outline-none border-b w-full pb-2 border-sky-400 placeholder-gray-500" name="nama_dpi"  placeholder="Name "/>
            </div>
            <div>
                 <input type="text" class="focus:outline-none border-b w-full pb-2 border-sky-400 placeholder-gray-500" name="luas"  placeholder="Luas "/>
            </div>
